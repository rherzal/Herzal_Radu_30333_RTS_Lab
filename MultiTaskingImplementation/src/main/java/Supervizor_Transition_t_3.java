...
public class Supervizor_Transition_t_3 implements TransitionTemplate {
    ...
    public Supervizor_Transition_t_3( String name, PlaceHandlerTemplate PH,Integer delay) {
        this.Init(name, PH);
        this.SetDelay(delay);
    }

    public Supervizor_Transition_t_3( String name, PlaceHandlerTemplate PH,Integer eet, Integer let) {
        this.Init(name, PH);
